...
# Пункты задачи:
# 1.  функции apply_all_func создайте пустой словарь reuslts.
# 2. Переберите все функции из *functions.
# 3. При переборе функций записывайте в словарь reuslts результат работы этой функции под ключом её названия.
